...
class BaseLegalEntityDocsPDF(ABC):
    ...
    def __get_global_params(self):
        self.director_name = 'Директор Директорович'
        self.organization_name = 'Индивидуальный Предприниматель Директор Директорович'
        self.organization_inn = '5410001111'
        self.organization_phone = '8-111-1111-1111'
        self.organization_email = '81111111111@mail.ru'
        self.organization_addres = '11111, г. Город, ул. Улица, д. 11/1, кв. 111'
        self.current_account = '408111111111111111111'
        self.bank = 'ВТБ (ПАО)'
        self.correspondent_account = '3011111111111111111411'
        self.bik = '011111111'
        self.okved = '45.20.3'
        self.ogrnip = '32111111111111'
        self.inn = '541111111111'
