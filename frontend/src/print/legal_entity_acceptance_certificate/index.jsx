  ...
  return (
    <div>
      ...
      >
        ...
        <div className="row">
          <div className="col text-start">г. Город</div>
        ...
        <br></br>
        <p>
          Индивидульный предприниматель Директор Дирекуторович (далее ИП
          Директор Е. Л.), именуемый в дальнейшем &quot;ИСПОЛНИТЕЛЬ&quot;,
          ...
          <div className="row mb-0" style={{ textAlign: "left" }}>
            <div className="col">
              <span>
                ИСПОЛНИТЕЛЬ:<br></br>
                <br></br>
                ________________________________ ДИректор Е. Л.<br></br>
