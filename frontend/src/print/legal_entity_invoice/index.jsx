        ...
        <div className="row">
              ...
              <tbody>
                ...
                <tr>
                  <td
                    ...
                    style={{ textAlign: "left" }}
                  >
                    Индивидуальный Предприниматель Директор Директорович
                  </td>
                  <td
          ...
          <div className="col-3">
            <QRCodeSVG
              ...
              value={`ST00012|Name=Индивидуальный предприниматель Директор Директорович|PersonalAcc=408111111111111111111111|BankName=Филиал "Центральный" Банка ВТБ (ПАО), г. Моск|BIC=044525411|CorrespAcc=301111111111111111111|PayeeINN=54101111111111|Purpose=Оплата по счёту №${
                invoice?.id
              }, от ${new Date(
          ...
          <tbody>
            <tr>
              ...
              <td className="fw-bold">
                Индивидуальный предприниматель Директор Директорович, ИНН
                5411111111111111, ОБЛ. ОБЛАСТНАЯ, Г. ГОРОД
              </td>
            </tr>
            <tr>
